...
function acf_get_url( $filename = '' ) {
	//if ( ! defined( 'ACF_URL' ) ) {
//		define( 'ACF_URL', 'http://localhost/test/work/wordpress/wp-content/plugins/'/*acf_get_setting( 'url' )*/ );
//	}
	//echo "\n====>".ACF_URL;
	//die;//echo acf_get_setting( 'url' );die;
	return THEME_PLUGIN_URL.'advanced-custom-fields/'. ltrim( $filename, '/' );
}
